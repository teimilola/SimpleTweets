...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "arzcORoegr8orU97OfnXTWllD";       // Change this
	public static final String REST_CONSUMER_SECRET = "wbSmDCKy16q1fwQPiWqb5VxxT88vsjqamNImBFJgc2Qkkq0l2U"; // Change this
   ...
   // since_id= 1
    ...
    public void deleteFavorite(long id, AsyncHttpResponseHandler handler){
    ...
    public void unRetweet(long id, AsyncHttpResponseHandler handler){
        String apiUrl= getApiUrl("statuses/unretweet/" + String.valueOf(id) + ".json");
        RequestParams params= new RequestParams();
        params.put("id", id);
        getClient().post(apiUrl, params, handler);
    }
